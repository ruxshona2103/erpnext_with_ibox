...
frappe.ui.form.on("Kassa", {
    refresh: function(frm) {
        ...
        frm.set_query("expense_account", function() {
            return {
                query: "erpnext_with_ibox.ibox.doctype.kassa.kassa.get_expense_accounts",
                filters: {
    ...
    mode_of_payment: function(frm) {
        if (frm.doc.mode_of_payment && frm.doc.company) {
            frappe.call({
                method: "erpnext_with_ibox.ibox.doctype.kassa.kassa.get_cash_account_with_currency",
                args: {
    ...
    update_balance: function(frm) {
        if (frm.doc.cash_account && frm.doc.company) {
            frappe.call({
                method: "erpnext_with_ibox.ibox.doctype.kassa.kassa.get_account_balance",
                args: {
    ...
    set_mode_of_payment_to_query: function(frm) {
        frm.set_query("mode_of_payment_to", function() {
            ...
            return { filters: filters, page_length: 500 };
        });
    },
    ...
    fetch_exchange_rate: function(frm) {
        ...
        frappe.call({
            method: "erpnext_with_ibox.ibox.doctype.kassa.kassa.get_exchange_rate",
            args: {
    ...
    party: function(frm) {
        if (frm.doc.party && frm.doc.party_type) {
            ...
            if (in_list(["Customer", "Supplier"], frm.doc.party_type)) {
                frappe.call({
                    method: "erpnext_with_ibox.ibox.doctype.kassa.kassa.get_party_currency",
                    args: {
